...
void Window::MakeContextCurrent() { glfwMakeContextCurrent(window_); }
...
void Window::MouseScrollCallback(GLFWwindow* glfw_window, double x_offset,
                                 double y_offset) {
  CallWndMethod<&Window::OnMouseScroll>(
      glfw_window, static_cast<float>(x_offset), static_cast<float>(y_offset));
}
